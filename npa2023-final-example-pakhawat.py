#######################################################################################
# FirstName/Surname: Pakhawat Punpakdeewong
# Student ID: 65070165
...
accessToken = "Bearer OWY5ODlmN2UtMGVmOC00ZjRlLWI0YmItZGY4ZWRlYzBjNGIxMWEzMDQzZTItN2Rl_P0A1_bc884c7a-820b-497b-8b60-00b4d15ea95d" 
...
roomIdToGetMessages = "Y2lzY29zcGFyazovL3VybjpURUFNOnVzLXdlc3QtMl9yL1JPT00vZGFkOTIzZjAtODg4Yi0xMWVmLTg1YTQtYTFkNTIyM2UxMjAz"
...
# # --------------------------------------------------------------------
    ...
    if message.find("/pakhawat") == 0:
        ...
        location = message[len("/pakhawat "):].strip()
...
# 5. Prepare openweather Geocoding APIGetParameters..
        ...
        openweatherGeoAPIGetParameters = {
            "q": location,
            "limit": 1,
            "appid": "0765435061c6a093577fc4f41a0904e8",
        }
